...
<body>
    <div class="d-flex flex-column min-vh-100">
        ...
        <div class="header">
                <div class="container-fluid d-flex flex-row align-items-center text-center py-2 flex-wrap" style="gap: 40px;">
                <a href="homepage.html" class="text-decoration-none flex-grow-0">
                    <h5 class="mb-0"><b>Cerina's Sari2Store</b></h5>
                </a>

                <div class="d-flex flex-grow-1 flex-wrap">
                    <div class="col-12 col-md-10 d-flex flex-row mb-2 mb-md-0">
