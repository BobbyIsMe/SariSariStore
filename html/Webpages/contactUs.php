    ...
    <main class="flex-fill">
      <section class="body_container p-5">
        ...
        <div class="about-section-wrapper d-flex flex-column flex-lg-row justify-content-center gap-4">
          ...
          <div class="creator-box flex-grow-1 justify-content-between">
            ...
            <div class="creator-profile d-flex align-items-start mb-4">
              <div class="avatar-img ">
                ...
                <img src="../../icons/Gmail Logo.png" alt="Contact Avatar" class="bembi-logo"
                  style="height: 80px; width: 80px; object-fit: cover; border-radius: 6px;">
              </div>
              <div class="creator-details">
          ...
          <div class="faq-box flex-grow-1">
            ...
            <p><b>955 Archbishop Reyes Ave
            Cebu City, Central Visayas</b></p>
            <p style="text-align: justify;">
              From de los santos banner on the google maps,you go straight until you hit a house. Afterwards go right
              until you reach a curved path then go left a bit and you will see the sari-sari store.
