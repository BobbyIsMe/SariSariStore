                          ...
                          <div class="modal-content p-3">
                            ...
                            <div class="modal-body" style=" overflow-y: auto;">
                              ...
                              <div class="notification_card d-flex mb-3">
                                ...
                                <div class="d-flex flex-column flex-grow-1"  >
                                      <div class="fw-bold">Order ID# 3</div>
                                      <div class="notification_message">Your reservation has been approvedjdsiahdshdsahdshdsahdiashiudashudashuidshaiudhsaiudhsauidhsauidhsauidhsuaihdasuihdsuiahdas</div>
                                  ...
                                  <div class="p-4 d-flex justify-content-center align-items-center gap-4">
                                    <button class="navButton" type="button" id="prev_button"></button>
                                    <span>|</span>
